...
data_path =  r"path-to\results_medical\all_ks_results_medical.csv"
...
output_dir = Path(r'path-to\Fidelity_Viz\Similarity_plots')
...
plt.legend(prop={'family': 'Times New Roman', 'size': 8})
plt.xlabel(r"", fontsize=8, fontname="Times New Roman")
plt.ylabel(r"Mean of KS statistic", fontsize=8, fontname="Times New Roman")
# plt.title(r"Distributional Fidelity per Hardness Metric (Averaged over Strategies)", fontsize=8, fontname="Times New Roman")

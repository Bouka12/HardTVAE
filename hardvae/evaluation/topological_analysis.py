...
# Load the data
data_path = r"C:\Users\BOUKA\Downloads\PART2-Hardness-CSVAE\Hard-CSVAE\fidelity_results_medical\fidelity_results_topological.csv"
...
output_dir = Path(r'C:\Users\BOUKA\Downloads\PART2-Hardness-CSVAE\Hard-CSVAE\Fidelity_Viz\Topology_plots')
...
plt.ylabel("Mean of Bottleneck distance (H0)", fontsize=10)
...
plt.xlabel("", fontsize=14)
plt.ylabel(r"\textit{Mean of Bottleneck Distance (H0)}", fontsize=14)
# plt.title("Topological Fidelity per Hardness Metric (Averaged over Strategies)", fontsize=16)
...
# # Create summary heatmap across all datasets => HERE WE GO 03/12/2025 7.31pm

...
data_path =  r"C:\Users\BOUKA\Downloads\PART2-Hardness-CSVAE\Hard-CSVAE\fidelity_results_medical\fidelity_results_hardness.csv"
...
output_dir = Path(r'C:\Users\BOUKA\Downloads\PART2-Hardness-CSVAE\Hard-CSVAE\Fidelity_Viz\Hardness_plots')
...
# plt.title(r"\textit{Hardness-based Fidelity per Hardness Metric (Averaged over Strategies)}", fontsize=16)

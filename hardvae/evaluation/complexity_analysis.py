...
data_path = r"C:\Users\BOUKA\Downloads\PART2-Hardness-CSVAE\Hard-CSVAE\fidelity_results_medical\fidelity_results_complexity.csv"
...
output_dir = Path(r'C:\Users\BOUKA\Downloads\PART2-Hardness-CSVAE\Hard-CSVAE\Fidelity_Viz\Complexity_plots')
...
plt.ylabel(r"\textit{Mean of Absolute Difference}", fontsize=10)
...
plt.xlabel(r"\textit{Hardness Metric}", fontsize=14)
plt.ylabel(r"\textit{Mean of Absolute Difference}", fontsize=14)
